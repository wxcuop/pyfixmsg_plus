...
class FixEngine:
    ...
    async def send_message(self, message):
        ...
        fix_message.direction = 1  # Set the direction to outbound (1)
        fix_message.time = datetime.utcnow()  # Set the current time
        fix_message.recipient = self.target  # Set the recipient to the target
